...
static void settings_reset_bg_cont(lv_obj_t* parent)
{
	...
	set_language_string(title_label, 40, language_table_reset_device);
	...
	set_language_string(describe_label, 24, language_table_warning_reset_device);
...
{
    gui_algo_data_set_pagelocation("settings_reset",0);
    p_settings_reset = (settings_reset_t*)lv_mem_alloc(sizeof(settings_reset_t));
